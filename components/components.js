...
function initActiveNavigation() {
    ...
    /*
     * Normalizza il pathname in modo da funzionare
     * sia su GitHub Pages sia sul dominio definitivo.
     */
    let currentPath =
        decodeURIComponent(
    ...
    links.forEach(
        link => {
            ...
            /*
             * Confrontiamo solo il file/pagina.
             * Gli hash della Home non vengono usati come
             * stato pagina attivo.
             */
            if (
                linkPath ===
...
function initMobileMenu() {
    ...
    dropdowns.forEach(
        dropdown => {
            ...
            /*
             * DESKTOP:
             * il dropdown si apre solo al passaggio del mouse.
             *
             * MOBILE:
             * il dropdown continua ad aprirsi al tap/click.
             */
